...
with(this){return _c('p',[_v("The sequence diagram below illustrates the interactions within the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" component, taking\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("execute(\"contact delete 1\")")]),_v(" API call\nas an example.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("How the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" component works:")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("When "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" is called upon to execute a command, it is passed to an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TutorEaseParser")]),_v(" object which in turn creates\na parser that matches the command (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteContactCommandParser")]),_v(") and uses it to parse the command.")]),_v(" "),_c('li',[_v("This results in a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(" object (more precisely, an object of one of its subclasses e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteContactCommand")]),_v(")\nwhich is executed by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(".")]),_v(" "),_c('li',[_v("The command can communicate with the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" when it is executed (e.g. to delete a person)."),_c('br'),_v("\nNote that although this is shown as a single step in the diagram above (for simplicity), in the code it can take\nseveral interactions (between the command object and the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(") to achieve.")]),_v(" "),_c('li',[_v("The result of the command execution is encapsulated as a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandResult")]),_v(" object which is returned back from "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(".")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("When called upon to parse a user command, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TutorEaseParser")]),_v(" class creates an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("XYZCommandParser")]),_v(" ("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("XYZ")]),_v(" is a\nplaceholder for the specific command name e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddContactCommandParser")]),_v(") which uses the other classes shown above\nto parse the user command and create a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("XYZCommand")]),_v(" object (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddContactCommand")]),_v(") which the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TutorEaseParser")]),_v("\nreturns back as a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(" object.")]),_v(" "),_c('li',[_v("All "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("XYZCommandParser")]),_v(" classes (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddContactCommandParser")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteContactCommandParser")]),_v(", ...) inherit from the\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Parser")]),_v(" interface so that they can be treated similarly where possible e.g, during testing.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("These operations are exposed in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" interface as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitAddressBook()")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#undoAddressBook()")]),_v("\nand "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#redoAddressBook()")]),_v(" respectively.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Step 2. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("contact delete 5")]),_v(" command to delete the 5th person in the address book. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("contact delete")]),_v("\ncommand calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitAddressBook()")]),_v(", causing the modified state of the address book after the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("contact delete 5")]),_v("\ncommand executes to be saved in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addressBookStateList")]),_v(", and the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" is shifted to the newly\ninserted address book state.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 3. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("contact add /nDavid …​")]),_v(" to add a new person. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("contact add")]),_v(" command also\ncalls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitAddressBook()")]),_v(", causing another modified address book state to be saved into\nthe "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addressBookStateList")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("As a")]),_v(" "),_c('th',[_v("I want to")]),_v(" "),_c('th',[_v("So that I can")]),_v(" "),_c('th',[_v("Priority")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_v("Potential user exploring app")]),_v(" "),_c('td',[_v("Have a guided tour showing the functions upon first opening")]),_v(" "),_c('td',[_v("Have a better idea and navigate easily when using the app.")]),_v(" "),_c('td',[_v("3")])]),_v(" "),_c('tr',[_c('td',[_v("Potential user exploring app")]),_v(" "),_c('td',[_v("See the test data inside the app (i.e. address book release)")]),_v(" "),_c('td',[_v("Easily see how the app functions when it is in use.")]),_v(" "),_c('td',[_v("3")])]),_v(" "),_c('tr',[_c('td',[_v("New user to the app")]),_v(" "),_c('td',[_v("Purge all test data")]),_v(" "),_c('td',[_v("Start writing in my own data")]),_v(" "),_c('td',[_v("3")])])])])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("As a")]),_v(" "),_c('th',[_v("I want to")]),_v(" "),_c('th',[_v("So that I can")]),_v(" "),_c('th',[_v("Priority")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Add and delete my students' contacts")]),_v(" "),_c('td',[_v("Keep track of my students")]),_v(" "),_c('td',[_v("MVP")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Add and delete my students' guardians' contacts")]),_v(" "),_c('td',[_v("Keep track of my students’ guardians")]),_v(" "),_c('td',[_v("2")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Keep track of the house address of a student for home tuition")]),_v(" "),_c('td',[_v("Easily go to their house when their tuition starts")]),_v(" "),_c('td',[_v("MVP")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Keep track of Zoom meeting link of a student for online tuition")]),_v(" "),_c('td',[_v("Easily go to the online meeting room when tuition starts")]),_v(" "),_c('td',[_v("MVP")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Store what was done in the lessons")]),_v(" "),_c('td',[_v("Track what was done and plan for next lessons easier")]),_v(" "),_c('td',[_v("2")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Create and delete lesson slots in my schedule")]),_v(" "),_c('td',[_v("Keep track of my lessons")]),_v(" "),_c('td',[_v("MVP")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("List all my lesson slots in my schedule")]),_v(" "),_c('td',[_v("Keep track of my lessons")]),_v(" "),_c('td',[_v("MVP")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("List all my contacts")]),_v(" "),_c('td',[_v("Keep track of my contacts")]),_v(" "),_c('td',[_v("MVP")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Categorize my students based on subjects or grade levels")]),_v(" "),_c('td',[_v("Know what type of lesson it is")]),_v(" "),_c('td',[_v("2")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Keep track of my students' exam dates")]),_v(" "),_c('td',[_v("Prepare my students adequately by then")]),_v(" "),_c('td',[_v("2")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Edit student details (address, fees, exam, subject, grade level, etc.)")]),_v(" "),_c('td',[_v("Ensure my students' details are up to date")]),_v(" "),_c('td',[_v("2")])])])])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("As a")]),_v(" "),_c('th',[_v("I want to")]),_v(" "),_c('th',[_v("So that I can")]),_v(" "),_c('th',[_v("Priority")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Mark a lesson as completed or cancelled")]),_v(" "),_c('td',[_v("Maintain accurate records of attendance and lesson statuses.")]),_v(" "),_c('td',[_v("2")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Be able to make my lesson slots repeat every week")]),_v(" "),_c('td',[_v("Avoid creating the same lesson slot every week")]),_v(" "),_c('td',[_v("2")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Keep track of my students' homework (i.e., done status, deadline)")]),_v(" "),_c('td',[_v("Track the progress of my students and keep them accountable")]),_v(" "),_c('td',[_v("2")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Change the lesson slot just for that week/all subsequent weeks")]),_v(" "),_c('td',[_v("Easily reschedule lessons")]),_v(" "),_c('td',[_v("2")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Know if I have accidentally scheduled a class at a conflicting time slot")]),_v(" "),_c('td',[_v("Avoid troubling students to reschedule after agreeing on a time slot")]),_v(" "),_c('td',[_v("2")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Keep track of when and how much each student/guardian needs to pay")]),_v(" "),_c('td',[_v("Collect my fees timely and accurately")]),_v(" "),_c('td',[_v("2")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Tag students under their guardian")]),_v(" "),_c('td',[_v("Track total fees to collect")]),_v(" "),_c('td',[_v("2")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Automatically update the amount of fee I collect after a lesson")]),_v(" "),_c('td',[_v("Avoid manually update and track fees")]),_v(" "),_c('td',[_v("2")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Batch delete all scheduled lessons with a student")]),_v(" "),_c('td',[_v("Remove all students' classes")]),_v(" "),_c('td',[_v("2")])])])])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("As a")]),_v(" "),_c('th',[_v("I want to")]),_v(" "),_c('th',[_v("So that I can")]),_v(" "),_c('th',[_v("Priority")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Export student progress reports (compiled lesson descriptions)")]),_v(" "),_c('td',[_v("Provide detailed updates to their guardians every term/semester")]),_v(" "),_c('td',[_v("3")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Set reminders for upcoming lessons")]),_v(" "),_c('td',[_v("Prepare for a lesson and will not miss any")]),_v(" "),_c('td',[_v("3")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Set reminders to collect payment")]),_v(" "),_c('td',[_v("Collect my fees on time")]),_v(" "),_c('td',[_v("3")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("View a history of all my previous lessons with each student")]),_v(" "),_c('td',[_v("Reference past lessons and track long-term progress")]),_v(" "),_c('td',[_v("3")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Autofill commands with what is expected next")]),_v(" "),_c('td',[_v("Avoid re-typing long commands")]),_v(" "),_c('td',[_v("3")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Export previous years' data into a file")]),_v(" "),_c('td',[_v("Manage each year separately and not overcrowd my data")]),_v(" "),_c('td',[_v("3")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Generate monthly or weekly reports of my hours worked/earnings")]),_v(" "),_c('td',[_v("Track my productivity and workload")]),_v(" "),_c('td',[_v("3")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Know what I need to bring/prepare for all my lessons in the upcoming day")]),_v(" "),_c('td',[_v("Adequately prepare for each lesson and ensure my students have necessary materials")]),_v(" "),_c('td',[_v("3")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Tag various students under the same lesson slot for group lessons")]),_v(" "),_c('td',[_v("Cater to different lesson types and optimize time")]),_v(" "),_c('td',[_v("3")])]),_v(" "),_c('tr',[_c('td',[_v("Tutor")]),_v(" "),_c('td',[_v("Manage multiple locations for students")]),_v(" "),_c('td',[_v("Adjust if students have multiple locations for tuition")]),_v(" "),_c('td',[_v("3")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TutorEase")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use Case: UC04 - Find contacts with a specific name keyword")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Tutor keys in a keyword in the required field to find contacts whose names contain this keyword.")]),_v(" "),_c('li',[_v("TutorEase lists the contacts with the given keyword."),_c('br'),_v("\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")]),_v(":")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("1a")]),_v(". TutorEase detects bad or wrongly formatted inputs.")]),_v(" "),_c('ul',[_c('li',[_c('strong',[_v("1a1")]),_v(". TutorEase prompts Tutor with correct format.")]),_v(" "),_c('li',[_c('strong',[_v("1a2")]),_v(". Tutor enters new data."),_c('br'),_v("\nSteps 1a1 to 1a2 are repeated until the data entered are correct."),_c('br'),_v("\nUse case resumes from Step 2.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("1b")]),_v(". No contacts found matching the entered keyword.")]),_v(" "),_c('ul',[_c('li',[_c('strong',[_v("1b1")]),_v(". TutorEase displays a message: \"No contacts found with the given keyword(s).\"")]),_v(" "),_c('li',[_c('strong',[_v("1b2")]),_v(". Tutor enters a new keyword or cancels the search."),_c('br'),_v("\nUse case resumes from Step 2 or ends if cancelled.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: UC05 - Add lesson for student")]),_c('br'),_v(" "),_c('strong',[_v("MSS:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Tutor keys in required fields to add student contact.")]),_v(" "),_c('li',[_v("TutorEase adds the lesson to the student."),_c('br'),_v("\nUse case ends.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use Case: UC06 - Delete lesson for student")]),_c('br'),_v(" "),_c('strong',[_v("MSS:")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use Case: UC07 - List all lessons")]),_c('br'),_v(" "),_c('strong',[_v("MSS:")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be\nable to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("Data Requirements:\n"),_c('ul',[_c('li',[_v("Size: System must be able to handle at least 1,000 student records, with each containing personal information and\nlesson schedules.")]),_v(" "),_c('li',[_v("Volatility: Contact information is not expected to be changed frequently, but lessons schedules may change\nfrequently. System must allow quick updates without issues.")]),_v(" "),_c('li',[_v("Data persistency: all students and lesson data should be stored and retrievable until entry has been deleted.")])])]),_v(" "),_c('li',[_v("Environment Requirements:\n"),_c('ul',[_c('li',[_v("Technical Compatability: System must be compatible with "),_c('em',[_v("Mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above\ninstalled.")]),_v(" "),_c('li',[_v("Server Requirements: stored locally.")])])]),_v(" "),_c('li',[_v("Capacity:\n"),_c('ul',[_c('li',[_v("User Capacity: System is designed for local use and therefore for 1 local user.")]),_v(" "),_c('li',[_v("Data Capacity: as mentioned above within Data Requirements.")])])]),_v(" "),_c('li',[_v("Documentation:\n"),_c('ul',[_c('li',[_v("User Guide: A complete user guide will be provided for tutor, detailing every command and cover common\ntroubleshooting scenarios.")]),_v(" "),_c('li',[_v("Developer Guide: Comprehensive developer guide will be available, to facilitate future development and\nmaintenance.")])])]),_v(" "),_c('li',[_v("Fault Tolerance:\n"),_c('ul',[_c('li',[_v("Error handling: System should handle up to 90% of incorrect inputs (incorrect date formats, missing fields or etc)\nwithout crashing and should provide meaningful error messages to guide users to correct the input.")])])]),_v(" "),_c('li',[_v("Maintability:\n"),_c('ul',[_c('li',[_v("System should have modular components that are easily replaceable or upgradable without affecting the application.")])])]),_v(" "),_c('li',[_v("Portability:\n"),_c('ul',[_c('li',[_v("System must be portable across devices with different operating systems, allowing tutors to install it easily.")])])]),_v(" "),_c('li',[_v("Quality:\n"),_c('ul',[_c('li',[_v("Ease of Use: System should be usable by tutors with minimal computer literacy and include intuitive CLI commands\nand user-friendly prompts.")]),_v(" "),_c('li',[_v("Testing coverage: Unit tests should cover at least 60% of codebase, ensuring high reliability during future\nupdates.")])])]),_v(" "),_c('li',[_v("Testability:\n"),_c('ul',[_c('li',[_v("Automated Testing: System should support automated unit and integration testing for continuous integration,\nallowing future updates to be tested without manual intervention.")])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Wed, 23 Oct 2024, 12:50:09 GMT+8]")])])])}
}];
